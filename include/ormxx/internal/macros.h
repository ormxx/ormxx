...
#define __ORMXX_STRUCT_SCHEMA_DECLARE_FIELD_BUILDER(Field)                                                   \
    ::ormxx::internal::FieldBuilder<decltype(BaseStruct::Field)> Field{                                      \
            ::ormxx::internal::InjectUtility::GenerateFieldBuilder<BaseStruct, decltype(BaseStruct::Field)>( \
                    __ORMXX_STR(Field))};
...
private:                                                                                        \
    ...
    __ORMXX_EXPEND_FUNC_(__ORMXX_STRUCT_SCHEMA_DECLARE_SET_AND_GET_FUNCTION, __VA_ARGS__)       \
                                                                                                \
    class __ORMXX_FieldBuilder {                                                                \
        using BaseStruct = Struct;                                                              \
                                                                                                \
    public:                                                                                     \
        __ORMXX_EXPEND_FUNC_(__ORMXX_STRUCT_SCHEMA_DECLARE_FIELD_BUILDER, __VA_ARGS__)          \
    };                                                                                          \
                                                                                                \
    static const __ORMXX_FieldBuilder& __ORMXX_NewFieldBuilder() {                              \
        static auto q = __ORMXX_FieldBuilder{};                                                 \
        return q;                                                                               \
    }                                                                                           \
                                                                                                \
    template <typename T,                                                                       \
